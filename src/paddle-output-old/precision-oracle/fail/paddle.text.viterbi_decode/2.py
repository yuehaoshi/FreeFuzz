...
import paddle
import time
arg_1_tensor = paddle.randint(-1024,16384,[61, 4, 3], dtype=paddle.float16)
arg_1 = arg_1_tensor.clone()
arg_2_tensor = paddle.randint(-2,128,[3, 3], dtype=paddle.float16)
arg_2 = arg_2_tensor.clone()
arg_3_tensor = paddle.randint(-1,16,[2], dtype=paddle.int8)
