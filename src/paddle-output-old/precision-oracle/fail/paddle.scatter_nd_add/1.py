...
import paddle
import time
arg_1_tensor = paddle.rand([3, 5, 9, 10], dtype=paddle.float16)
arg_1 = arg_1_tensor.clone()
arg_2_tensor = paddle.randint(-128,16,[3, 2], dtype=paddle.int8)
arg_2 = arg_2_tensor.clone()
arg_3_tensor = paddle.rand([3, 9, 10], dtype=paddle.float16)
